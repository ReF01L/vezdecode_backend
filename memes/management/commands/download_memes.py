...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i in range(self.get_photos(connection, os.environ.get('album_id', '283939598'), os.environ.get('owner_id', '-197700721'), offset=0)['count'] // 50 + 1):
            response = self.get_photos(connection, os.environ.get('album_id', '283939598'), os.environ.get('owner_id', '-197700721'), offset=i * 50)
